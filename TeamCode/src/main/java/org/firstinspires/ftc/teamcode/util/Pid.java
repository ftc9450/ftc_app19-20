...
/**
 * Obtained from https://github.com/pmtischler/ftc_app/blob/master/SharedCode/src/main/java/com/github/pmtischler/control/Pid.java
...
public class Pid {
    ...
    public double update(double desiredValue, double actualValue, double dt) {
        ...
        double output = clampValue(kp * e + (runningIntegral * ti) + (td * d), // changes / to * so that I can be 0
                outputMin, outputMax);
